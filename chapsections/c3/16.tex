...
> Approach the windswept precipice -- \turnto{c316x1}\\
\requiresx{7+ FTH} Investigate the nest -- \turnto{c316x2}\\
\requiresx{NOT c325a} Explore the cloister cells -- \turnto{c325}\\
\requiresx{12+ ATT} Study the strange, dead thing -- \turnto{c316x4}\\
> Enter the desolate hygiene room -- \turnto{c318}\\
