...
\item \emph{Hidden Dagger} - Move 1. Deal 1 Slash damage and inflict Bleeding on an adjacent entity.
\end{itemize}

\begin{tcolorbox}
\textbf{Note:} Remember that Egor and Vitalik do not have the same Move score.
\end{tcolorbox}
