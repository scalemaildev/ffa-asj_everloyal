...
\item \textbf{6 Remaining:} \emph{The Lost Phalanx drags its dead members along by their chains, severely slowing the formation.} The Lost Phalanx loses 1 Move value.
...
\end{tcolorbox}
\begin{tcolorbox}
\textbf{Note:} \emph{Charge!} has \emph{Undodgeable} damage, but the character can still move out of the way via their \emph{Dodge!} if it has implicit Move
\end{tcolorbox}
\ \\
\hrule
\ \\
