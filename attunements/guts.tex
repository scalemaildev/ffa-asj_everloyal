...
\makeitem{Fury} & STR: 12 & 2 & 5 & F & The first melee attack committed this \emph{beat} gains \emph{Unblockable} and \emph{Unparryable} \\
\hline
\end{tabularx}
\end{center}
...
\makeitem{Slink} & DEX: 12 & 1 & 3 & F & Place character on the opposite hex of an adjacent enemy \\
